...
class Game:
    ...
    def __show(self):
        line1 = "   1    2    3"
        line2 = "---------------"
        line3 = "A" + " " + "|" + " " + self.field[0][0] + " " + "|" + " " + self.field[0][1] + " " + "|" + " " + self.field[0][2] + " " + "|"
        line4 = "---------------"
        line5 = "B" + " " + "|" + " " + self.field[1][0] + " " + "|" + " " + self.field[1][1] + " " + "|" + " " + self.field[1][2] + " " + "|"
        line6 = "---------------"
        line7 = "C" + " " + "|" + " " + self.field[2][0] + " " + "|" + " " + self.field[2][1] + " " + "|" + " " + self.field[2][2] + " " + "|"
        line8 = "---------------"
        print(line1)
        print(line2)
        print(line3)
